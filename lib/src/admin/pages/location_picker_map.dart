            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Tap or drag to set your geofence center',
                              style: TextStyle(
                                fontSize: 14,
                  ...
                  Row(
                    children: [
                      _buildInstructionItem(Icons.touch_app, 'Tap to place',
                          Colors.green),
                      const SizedBox(width: 16),
                      _buildInstructionItem(
                          Icons.drag_indicator, 'Drag marker', Colors.orange),
                      const SizedBox(width: 16),
                      _buildInstructionItem(
                          Icons.tune, 'Adjust radius', Colors.purple),
                    ],
                  ),
                ],
              ),
