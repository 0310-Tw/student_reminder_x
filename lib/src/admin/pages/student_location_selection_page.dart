...
import 'package:students_reminder/src/admin/pages/location_picker_map.dart';
  ...
  Widget _buildNavigationButtons() {
    return Column(
      ...
      children: [
        ...
        // Enhanced Quick Access to Incident History
        Container(
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'Check your location compliance records',
                            style: TextStyle(
        ...
        // Enhanced Quick Access to Geofence Dashboard
        Container(
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(16),
            gradient: LinearGradient(
          ...
          child: Material(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(16),
              onTap: () {
                Navigator.pushNamed(context, AppRoutes.geofenceDashboard);
              },
              child: Padding(
                padding: const EdgeInsets.all(16),
                child: Row(
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'View current status and check in/out',
                            style: TextStyle(
                              color: Colors.white70,
                              fontSize: 13,
                            ),
