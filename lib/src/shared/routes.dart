...
import 'package:students_reminder/src/admin/pages/student_location_selection_page.dart';
...
import 'package:students_reminder/src/admin/pages/student_geofence_dashboard.dart';
import 'package:students_reminder/src/features/geofence_incident_history.dart';
...
case geofenceDashboard:
  return MaterialPageRoute(builder: (_) => const StudentGeofenceDashboard());
case locationSelection:
  return MaterialPageRoute(builder: (_) => const StudentLocationSelectionPage());
case geofenceIncidents:
  // Add your incident history page when ready
  return MaterialPageRoute(builder: (_) => const GeofenceIncidentHistory());
default:
  return MaterialPageRoute(builder: (_) => const SplashGate());
  // Add your incident history page when ready
  return MaterialPageRoute(builder: (_) => const GeofenceIncidentHistory());
